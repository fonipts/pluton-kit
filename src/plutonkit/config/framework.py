...
DEFAULT_GRPC = [
    format_argument("framework","default_grpc","Do you need docker","default",DOCKER_SETUP),
]

DEFAULT_WEB_SOCKET = [
    format_argument("framework","default_websocket","Do you need docker","default",DOCKER_SETUP),
]
