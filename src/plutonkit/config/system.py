...
SERVICE_TYPE = [
    format_argument_input("service_type","grpc","Your GRPC Framework","grpc",DEFAULT_GRPC),
    format_argument_input("service_type","web","Your web framework choice","web",FRAMEWORK_WEB),
    format_argument_input("service_type","websocket","Websocket Framework","websocket",DEFAULT_WEB_SOCKET),
