...
|create_project | Start creating your project in our listed framework  | `plutonkit create_project` or `plutonkit create_project source=<directory name>` |
...
[pip-image]: https://img.shields.io/badge/plutonkit-1.0.32a1-brightgreen
