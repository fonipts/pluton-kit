...
from .base import clone_project,command,create_achitecture,create_project,help,validate_blueprint

import unittest

class TestComment(unittest.TestCase):
    def test_clone_project(self):
        self.assertEqual(clone_project.comment(), 'Clone your project from project.yaml file')
    ...
    def test_create_project(self):
        self.assertEqual(create_project.comment(), 'Start creating your project in our listed framework')
    def test_help(self):
