...
setup(
    ...
    package_data={'': ['*.txt'],
                  'plutonkit.template':[
                      ...
                      'default_grpc/server/*',
                      'default_grpc/server/model/*',
                      'default_grpc/server/proto/*',
                      'default_grpc/server/service/*',
                      'default_grpc/server/utils/*',
                      ...
                      'default_grpc_w_interceptor/server/model/*',
                      'default_grpc_w_interceptor/server/proto/*',
                      'default_grpc_w_interceptor/server/service/*',
                      'default_grpc_w_interceptor/server/utils/*',
                      'default_web3/*',
                      'default_websocket/*',
                      'django/*',
                      'django/testapp/*',
